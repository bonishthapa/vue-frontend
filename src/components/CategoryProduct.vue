    ...
    <div class="category-product">
        <div class="container">
            <div v-if="scategory.product.length>1">
                <div class="row">
                    <div class="col-md-4" v-for="product in scategory.product" :key="product.id">
                        <div class="card" style="width: 18rem;" v-if="product.is_active" >
                            <img class="card-img-top" src="" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title" @click="fetchProductDetail(product.id)"><router-link :to="'/productdetail/'+product.id">{{product.name}}||{{product.is_active}} </router-link></h5>
