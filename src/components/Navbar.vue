  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <div class="nav-item" @click="loginUser">Login</div>  
        <div class="nav-item" @click="logoutUsers">Logout</div>
        <div class="nav-item">{{userDetail.username}}</div>
      </ul>  
    </div>
    </div>
  </nav>
...
export default {
  ...
  computed: mapGetters(["allCategory", "allCart","userDetail"]),
  created() {
    this.fetchCategory();
